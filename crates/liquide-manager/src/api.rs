...
pub fn default_endpoints() -> Vec<ApiEndpoint> {
    ...
    vec![
        ApiEndpoint {
            ...
            path: "/api/v1/dashboard".into(),
            min_role: AdminRole::Viewer,
            description: "Aggregate dashboard data".into(),
        },
        ApiEndpoint {
            method: HttpMethod::Get,
            path: "/api/v1/servers".into(),
            min_role: AdminRole::Viewer,
            description: "List managed servers".into(),
        },
        ApiEndpoint {
            method: HttpMethod::Get,
            path: "/api/v1/servers/{name}".into(),
            min_role: AdminRole::Viewer,
            description: "Server details".into(),
        },
        ApiEndpoint {
            method: HttpMethod::Put,
            path: "/api/v1/servers/{name}/config".into(),
            min_role: AdminRole::Admin,
            description: "Update server config".into(),
        },
        ApiEndpoint {
            method: HttpMethod::Post,
            path: "/api/v1/servers/{name}/restart".into(),
            min_role: AdminRole::Admin,
            description: "Restart server".into(),
        },
        ApiEndpoint {
            method: HttpMethod::Post,
            path: "/api/v1/servers/{name}/drain".into(),
            min_role: AdminRole::Admin,
            description: "Drain server".into(),
        },
        ApiEndpoint {
            method: HttpMethod::Get,
        ...
        ApiEndpoint {
            ...
            path: "/api/v1/sessions/{id}".into(),
            min_role: AdminRole::Operator,
            description: "Disconnect session".into(),
        },
        ApiEndpoint {
            method: HttpMethod::Post,
            path: "/api/v1/sessions/{id}/lock".into(),
            min_role: AdminRole::Operator,
            description: "Lock session".into(),
        },
        ApiEndpoint {
            method: HttpMethod::Post,
            path: "/api/v1/sessions/{id}/unlock".into(),
            min_role: AdminRole::Operator,
            description: "Unlock session".into(),
        },
        ApiEndpoint {
            method: HttpMethod::Get,
        ...
        ApiEndpoint {
            method: HttpMethod::Get,
            path: "/api/v1/users/{name}".into(),
            min_role: AdminRole::Viewer,
            description: "User details".into(),
        },
        ApiEndpoint {
            method: HttpMethod::Get,
            path: "/api/v1/policies".into(),
            min_role: AdminRole::Viewer,
            description: "List policies".into(),
        },
        ApiEndpoint {
            method: HttpMethod::Put,
            path: "/api/v1/policies".into(),
            min_role: AdminRole::Admin,
            description: "Update policies".into(),
        },
        ApiEndpoint {
            method: HttpMethod::Get,
            path: "/api/v1/metrics".into(),
            min_role: AdminRole::Viewer,
            description: "Metrics snapshot".into(),
        },
        ApiEndpoint {
            method: HttpMethod::Get,
            path: "/api/v1/gateways".into(),
            min_role: AdminRole::Viewer,
            description: "List gateways".into(),
        },
        ApiEndpoint {
            method: HttpMethod::Get,
            path: "/api/v1/gateways/{name}".into(),
            min_role: AdminRole::Viewer,
            description: "Gateway details".into(),
        },
        ApiEndpoint {
            method: HttpMethod::Get,
            path: "/api/v1/audit".into(),
            min_role: AdminRole::Viewer,
            description: "Audit log".into(),
        },
        ApiEndpoint {
            method: HttpMethod::Get,
            path: "/api/v1/crashes".into(),
            min_role: AdminRole::Viewer,
            description: "Crash reports".into(),
        },
        ApiEndpoint {
            method: HttpMethod::Get,
            path: "/api/v1/crashes/{id}".into(),
            min_role: AdminRole::Viewer,
            description: "Crash report details".into(),
        },
        ApiEndpoint {
            method: HttpMethod::Get,
            path: "/api/v1/plugins".into(),
            min_role: AdminRole::Viewer,
            description: "List plugins".into(),
        },
        ApiEndpoint {
            method: HttpMethod::Post,
            path: "/api/v1/plugins/install".into(),
            min_role: AdminRole::Admin,
