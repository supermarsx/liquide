...
pub fn register_defaults(registry: &mut ShortcutRegistry) {
    let defaults: Vec<(u8, KeyCode, ShortcutAction, ShortcutContext)> = vec![
        ...
        (
            MOD_SUPER,
            KeyCode::Space,
            ShortcutAction::Desktop(DesktopAction::ShowOverview),
        ...
        (
            MOD_SUPER,
            KeyCode::N,
            ShortcutAction::Desktop(DesktopAction::ShowNotifications),
            ShortcutContext::Global,
        ),
        // Window actions
        (
        ...
        (
            MOD_SUPER,
            KeyCode::Left,
            ShortcutAction::Window(WindowAction::TileLeft),
            ShortcutContext::Global,
        ),
        (
            MOD_SUPER,
            KeyCode::Right,
            ShortcutAction::Window(WindowAction::TileRight),
            ShortcutContext::Global,
        ),
        (
            MOD_SUPER,
            KeyCode::Up,
            ShortcutAction::Window(WindowAction::Maximize),
            ShortcutContext::Global,
        ),
        (
            MOD_SUPER,
        ...
        (
            MOD_SUPER,
            KeyCode::E,
            ShortcutAction::App(AppAction::Launch("file-manager".into())),
            ShortcutContext::Global,
        ),
        (
            MOD_SUPER,
            KeyCode::Tab,
            ShortcutAction::App(AppAction::CycleWindows),
            ShortcutContext::Global,
        ),
        (
            MOD_ALT,
        ...
        (
            MOD_NONE,
            KeyCode::VolumeUp,
            ShortcutAction::System(SystemAction::VolumeUp),
            ShortcutContext::Global,
        ),
        (
            MOD_NONE,
            KeyCode::VolumeDown,
            ShortcutAction::System(SystemAction::VolumeDown),
            ShortcutContext::Global,
        ),
        (
            MOD_NONE,
            KeyCode::VolumeMute,
            ShortcutAction::System(SystemAction::VolumeMute),
            ShortcutContext::Global,
        ),
        (
            MOD_NONE,
            KeyCode::BrightnessUp,
            ShortcutAction::System(SystemAction::BrightnessUp),
            ShortcutContext::Global,
        ),
        (
            MOD_NONE,
            KeyCode::BrightnessDown,
            ShortcutAction::System(SystemAction::BrightnessDown),
            ShortcutContext::Global,
        ),
        (
            MOD_NONE,
            KeyCode::MediaPlay,
            ShortcutAction::System(SystemAction::MediaPlay),
            ShortcutContext::Global,
        ),
        (
            MOD_NONE,
            KeyCode::MediaNext,
            ShortcutAction::System(SystemAction::MediaNext),
            ShortcutContext::Global,
        ),
        (
            MOD_NONE,
            KeyCode::MediaPrev,
            ShortcutAction::System(SystemAction::MediaPrev),
            ShortcutContext::Global,
        ),
        ...
        (
            MOD_SUPER,
            KeyCode::Digit1,
            ShortcutAction::Desktop(DesktopAction::SwitchWorkspace(1)),
            ShortcutContext::Global,
        ),
        (
            MOD_SUPER,
            KeyCode::Digit2,
            ShortcutAction::Desktop(DesktopAction::SwitchWorkspace(2)),
            ShortcutContext::Global,
        ),
        (
            MOD_SUPER,
            KeyCode::Digit3,
            ShortcutAction::Desktop(DesktopAction::SwitchWorkspace(3)),
            ShortcutContext::Global,
        ),
        (
            MOD_SUPER,
            KeyCode::Digit4,
            ShortcutAction::Desktop(DesktopAction::SwitchWorkspace(4)),
            ShortcutContext::Global,
        ),
        (
            MOD_SUPER,
            KeyCode::Digit5,
            ShortcutAction::Desktop(DesktopAction::SwitchWorkspace(5)),
            ShortcutContext::Global,
        ),
        (
            MOD_SUPER,
            KeyCode::Digit6,
            ShortcutAction::Desktop(DesktopAction::SwitchWorkspace(6)),
            ShortcutContext::Global,
        ),
        (
            MOD_SUPER,
            KeyCode::Digit7,
            ShortcutAction::Desktop(DesktopAction::SwitchWorkspace(7)),
            ShortcutContext::Global,
        ),
        (
            MOD_SUPER,
            KeyCode::Digit8,
            ShortcutAction::Desktop(DesktopAction::SwitchWorkspace(8)),
            ShortcutContext::Global,
        ),
        (
            MOD_SUPER,
            KeyCode::Digit9,
            ShortcutAction::Desktop(DesktopAction::SwitchWorkspace(9)),
            ShortcutContext::Global,
        ),
        ...
        (
            MOD_SUPER | MOD_SHIFT,
            KeyCode::Digit1,
            ShortcutAction::Window(WindowAction::MoveToWorkspace(1)),
            ShortcutContext::Global,
        ),
        (
            MOD_SUPER | MOD_SHIFT,
            KeyCode::Digit2,
            ShortcutAction::Window(WindowAction::MoveToWorkspace(2)),
            ShortcutContext::Global,
        ),
        (
            MOD_SUPER | MOD_SHIFT,
            KeyCode::Digit3,
            ShortcutAction::Window(WindowAction::MoveToWorkspace(3)),
            ShortcutContext::Global,
        ),
        (
            MOD_SUPER | MOD_SHIFT,
            KeyCode::Digit4,
            ShortcutAction::Window(WindowAction::MoveToWorkspace(4)),
            ShortcutContext::Global,
        ),
        (
            MOD_SUPER | MOD_SHIFT,
            KeyCode::Digit5,
            ShortcutAction::Window(WindowAction::MoveToWorkspace(5)),
            ShortcutContext::Global,
        ),
        (
            MOD_SUPER | MOD_SHIFT,
            KeyCode::Digit6,
            ShortcutAction::Window(WindowAction::MoveToWorkspace(6)),
            ShortcutContext::Global,
        ),
        (
            MOD_SUPER | MOD_SHIFT,
            KeyCode::Digit7,
            ShortcutAction::Window(WindowAction::MoveToWorkspace(7)),
            ShortcutContext::Global,
        ),
        (
            MOD_SUPER | MOD_SHIFT,
            KeyCode::Digit8,
            ShortcutAction::Window(WindowAction::MoveToWorkspace(8)),
            ShortcutContext::Global,
        ),
        (
            MOD_SUPER | MOD_SHIFT,
            KeyCode::Digit9,
            ShortcutAction::Window(WindowAction::MoveToWorkspace(9)),
            ShortcutContext::Global,
        ),
        ...
        (
            MOD_SUPER | MOD_CTRL,
            KeyCode::Up,
            ShortcutAction::Window(WindowAction::TileUp),
            ShortcutContext::Global,
        ),
        (
            MOD_SUPER | MOD_CTRL,
            KeyCode::Down,
            ShortcutAction::Window(WindowAction::TileDown),
            ShortcutContext::Global,
        ),
        // Log out
        (
...
mod tests {
    ...
    fn search_finds_defaults() {
        ...
        assert!(
            results
                .iter()
                .any(|e| e.action == ShortcutAction::Desktop(DesktopAction::LockScreen)),
