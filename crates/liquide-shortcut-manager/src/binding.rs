...
fn parse_key_code(s: &str) -> Result<KeyCode, ParseError> {
    ...
    if s.len() == 1 {
        ...
        if c.is_ascii_digit() {
            return match c {
                '0' => Ok(KeyCode::Digit0), '1' => Ok(KeyCode::Digit1),
                '2' => Ok(KeyCode::Digit2), '3' => Ok(KeyCode::Digit3),
                '4' => Ok(KeyCode::Digit4), '5' => Ok(KeyCode::Digit5),
                '6' => Ok(KeyCode::Digit6), '7' => Ok(KeyCode::Digit7),
                '8' => Ok(KeyCode::Digit8), '9' => Ok(KeyCode::Digit9),
                _ => Err(ParseError::UnknownKey(s.to_lowercase())),
            };
        }
    }
    ...
    match s.to_lowercase().as_str() {
        "f1" => Ok(KeyCode::F1), "f2" => Ok(KeyCode::F2), "f3" => Ok(KeyCode::F3),
        "f4" => Ok(KeyCode::F4), "f5" => Ok(KeyCode::F5), "f6" => Ok(KeyCode::F6),
        "f7" => Ok(KeyCode::F7), "f8" => Ok(KeyCode::F8), "f9" => Ok(KeyCode::F9),
        "f10" => Ok(KeyCode::F10), "f11" => Ok(KeyCode::F11), "f12" => Ok(KeyCode::F12),
        "f13" => Ok(KeyCode::F13), "f14" => Ok(KeyCode::F14), "f15" => Ok(KeyCode::F15),
        "f16" => Ok(KeyCode::F16), "f17" => Ok(KeyCode::F17), "f18" => Ok(KeyCode::F18),
        "f19" => Ok(KeyCode::F19), "f20" => Ok(KeyCode::F20), "f21" => Ok(KeyCode::F21),
        "f22" => Ok(KeyCode::F22), "f23" => Ok(KeyCode::F23), "f24" => Ok(KeyCode::F24),
...
fn key_code_name(key: KeyCode) -> &'static str {
    match key {
        ...
        KeyCode::Insert => "Insert", KeyCode::PrintScreen => "PrintScreen",
        ...
        KeyCode::Grave => "`",
        KeyCode::VolumeUp => "VolumeUp", KeyCode::VolumeDown => "VolumeDown",
        KeyCode::VolumeMute => "VolumeMute",
        KeyCode::BrightnessUp => "BrightnessUp", KeyCode::BrightnessDown => "BrightnessDown",
        KeyCode::MediaPlay => "MediaPlay", KeyCode::MediaNext => "MediaNext",
