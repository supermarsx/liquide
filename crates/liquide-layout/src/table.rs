...
enum TableGroupKind {
    ...
    Body,    // tbody / display: table-row-group (or bare rows)
    Footer,  // tfoot / display: table-footer-group
}
...
/// Check if a child is a table row group (thead/tbody/tfoot) that should be
/// treated as a passthrough container of rows.
