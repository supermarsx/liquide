...
impl FontPreview {
    ...
    pub fn pangram_for_language(lang: &str) -> &'static str {
        match lang.to_lowercase().as_str() {
            ...
            "de" => {
                "Victor jagt zw\u{00f6}lf Boxk\u{00e4}mpfer quer \u{00fc}ber den gro\u{00df}en Sylter Deich."
            }
            "fr" => {
                "Portez ce vieux whisky au juge blond qui fume sur son \u{00ee}le intoxiqu\u{00e9}e."
            }
            ...
            "pl" => {
                "Pchn\u{0105}\u{0107} w t\u{0119} \u{0142}\u{00f3}d\u{017a} je\u{017c}a lub o\u{015b}m skrzy\u{0144} fig."
            }
            "cs" | "cz" => {
                "P\u{0159}\u{00ed}li\u{0161} \u{017e}lu\u{0165}ou\u{010d}k\u{00fd} k\u{016f}\u{0148} \u{00fa}p\u{011b}l \u{010f}\u{00e1}belsk\u{00e9} \u{00f3}dy."
            }
            "ru" => {
            ...
            "ko" => {
                "\u{d0a4}\u{c2a4}\u{c758} \u{ace0}\u{c720}\u{c870}\u{ac74}\u{c740} \u{d0c0}\u{c778}\u{c5d0} \u{c758}\u{d574}\u{c11c} \u{ce68}\u{d574}\u{b420} \u{c218} \u{c5c6}\u{b2e4}."
            }
            "ar" => {
                "\u{0635}\u{0650}\u{0641} \u{062e}\u{064e}\u{0644}\u{0642}\u{064e} \u{0630}\u{0650}\u{0643}\u{0631}\u{064b}\u{0627} \u{0643}\u{064e}\u{0645} \u{062b}\u{064e}\u{0645}\u{064e}\u{0646}\u{064e} \u{0634}\u{064e}\u{0647}\u{062f}\u{064e} \u{0639}\u{064e}\u{0632}\u{064e} \u{0646}\u{064e}\u{0641}\u{0652}\u{0633}\u{064e} \u{0623}\u{064e}\u{062d}\u{064e}\u{062f}\u{064e} \u{0628}\u{0650}\u{0644}\u{0627} \u{0637}\u{064f}\u{0639}\u{0645}\u{064d} \u{0641}\u{064e}\u{0642}\u{064e}\u{062f}\u{0652}."
            }
            "hi" => {
                "\u{0928}\u{0939}\u{0940}\u{0902} \u{0928}\u{093e}\u{0928}\u{093e} \u{0915}\u{0939}\u{0924}\u{0947} \u{0939}\u{0948}\u{0902} \u{0917}\u{0927}\u{0947} \u{0915}\u{094b} \u{0939}\u{0940}\u{0930}\u{0947}."
            }
            "el" | "gr" => {
                "\u{039e}\u{03b5}\u{03c3}\u{03ba}\u{03b5}\u{03c0}\u{03ac}\u{03b6}\u{03c9} \u{03c4}\u{03b7}\u{03bd} \u{03c8}\u{03c5}\u{03c7}\u{03bf}\u{03c6}\u{03b8}\u{03cc}\u{03c1}\u{03b1} \u{03b2}\u{03b4}\u{03b5}\u{03bb}\u{03c5}\u{03b3}\u{03bc}\u{03af}\u{03b1}."
            }
            "tr" => {
                "Fahrettin\u{0027}in pi\u{015f}kin \u{00e7}orbac\u{0131}s\u{0131} m\u{00fc}jdeyi duyunca k\u{00fc}\u{00e7}\u{00fc}k bir ah \u{00e7}ekti."
            }
    ...
    pub fn supported_languages() -> &'static [&'static str] {
        &[
            "en", "de", "fr", "es", "it", "pt", "nl", "pl", "cs", "ru", "ja", "ko", "ar", "hi",
            "el", "tr",
        ]
    }
